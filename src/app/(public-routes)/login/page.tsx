    ...
    <>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-8">
        <div className="w-full max-w-[490px]">
          ...
          {/* Card */}
          <div className="rounded-[22px] border border-gray-200/50 bg-white px-10 py-10 shadow-[0_8px_40px_-8px_rgba(0,0,0,0.11),_0_2px_12px_-3px_rgba(0,0,0,0.06),_0_0_0_1px_rgba(0,0,0,0.03)]">
