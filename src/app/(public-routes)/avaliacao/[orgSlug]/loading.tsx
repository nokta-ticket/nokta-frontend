 ...
 * em vez de "carregando" (mesma lição aprendida em /cardapio/[orgSlug]).
 */
export default function Loading() {
  return (
    <main className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-[#faf9fb] text-sm text-muted-foreground">
      Carregando…
    </main>
  );
}
