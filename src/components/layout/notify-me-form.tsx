...
export default function NotifyMeForm() {
  ...
  if (open) {
    return (
      ...
      >
        {/* text-base (16px) no input: abaixo disso o Safari/iOS dá zoom
            automático ao focar o campo — mesma regra da busca do cardápio e
            da Central de Ajuda. */}
        <input
          type="email"
          required
          ...
          disabled={submitting}
          className="min-w-0 flex-1 bg-transparent text-base text-[#1E1B33] outline-none placeholder:text-[#9A9CAB]"
        />
        <button
          type="submit"
          disabled={submitting}
